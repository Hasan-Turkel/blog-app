      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header m-0">
            <h1 className="modal-title fs-3 text-primary" id="exampleModalLabel">
            UPDATE BLOG
            </h1>
            <button
              type="button"
      ...
      >
        {({
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={isSubmitting} className="btn btn-primary" data-bs-dismiss="modal">
              UPDATE
            </button>
          </Form>
        )}
